...
import com.taobao.demo.bean.JavaQuestionBean;
...
public class JavaQuestionActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   */
    public  void getData(){
        BmobQuery<JavaQuestionBean> query = new BmobQuery<>();
        query.order("-createdAt");
        //返回50条数据，如果不加上这条语句，默认返回10条数据
        //query.setLimit(50);
        //执行查询方法
        query.findObjects(new FindListener<JavaQuestionBean>() {
            @Override
            public void done(List<JavaQuestionBean> object, BmobException e) {
                if(e==null){
