...
package com.zoom.bundle_textview.surperTextView;
...
import com.zoom.bundle_textview.R;
...
public class MoveEffectAdjuster extends SuperTextView.Adjuster {
  ...
  public void adjust(SuperTextView v, Canvas canvas) {
    ...
    paint.setColor(v.getResources().getColor(R.color.colorAccent));
    //paint.setColor(v.getResources().getColor(color));
